cmd_lib/gen_crc32table := gcc -Wp,-MD,lib/.gen_crc32table.d -Ilib -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -pipe -o lib/gen_crc32table ../lib/gen_crc32table.c  
